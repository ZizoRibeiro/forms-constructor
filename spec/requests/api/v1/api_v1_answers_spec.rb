    ...
    context 'With valid authentication headers' do
      ...
      context 'When answer dont exists' do
        it 'returns status 404' do
          get "/api/v1/answers/#{FFaker::Lorem.word}",
              params: {},
              headers: header_with_authentication(@user)
          expect_status(404)
        end
  ...
  describe 'POST /answers' do
    context 'With valid authentication headers' do
      ...
      context 'And with valid form id' do
        before do
          @questions_answers_1_attributes = attributes_for(
            :questions_answer,
            question_id: @question.id
          )

          @questions_answers_2_attributes = attributes_for(
            :questions_answer,
            question_id: @question.id
          )
        ...
        it 'the answer is associated with the correct form' do
  ...
  describe 'DELETE /answers/:id' do
    ...
    context 'With Invalid authentication headers' do
      it_behaves_like :deny_without_authorization,
                      :delete, '/api/v1/answers/questionary'
    end
    ...
    context 'With valid authentication headers' do
      context 'When answer exists' do
        context 'And user is the owner' do
          ...
          it 'returns stauts 200' do
            expect_status(200)
          end

          it 'all answers are deleted' do
